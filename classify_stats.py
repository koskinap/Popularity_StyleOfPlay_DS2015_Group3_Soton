...
featureKeys = ['matchDate', 'matchId', 'team', 'teamNo', 'Attack' , 'Teamplay' , 'Agressiveness' , 'Accuracy' , 'Pressure' , 'googleTrendsIndex']
...
output = []
with inputFile as infile: # ,outputFile as outFile:
